install.packages(c("lme4", "devtools", "caret", "randomForest", "nlme", "Rcpp", "plyr",
                   "dplyr", "data.table", "ggplot2", "lubridate", "ggvis", "quantmod",
                   "zoo", "xts", "nnet", "HLMdiag", "roxygen2", "foreign", "leaflet",
                   "magrittr", "htmlwidgets", "shinydashboard",
